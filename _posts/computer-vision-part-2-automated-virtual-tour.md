...
We will first give an introduction of walkthrough, and why we need to build our own framework for this purpose. We will then jump right into the details of the computer vision system that generates virtual walkthroughs from sets of panoramas. Lastly we will show some walkthrough results we obtained from this approach, under different scenarios for indoor and outdoor.
